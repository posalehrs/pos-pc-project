...
public class Dollar extends MySprite {
    ...
    Font mFont;
    int heightFont = 20;//Chiều cao của text
    ...
    public void onLoadResources() {
        ...
        mFont = new Font(this.mFontTexture, Typeface.createFromAsset(
                mContext.getAssets(), "font/almosnow.ttf"), heightFont,
                true, Color.WHITE);
    ...
    public void onLoadScene(Scene mScene) {
        ...
        x_end_dollar = x + this.mFont.getStringWidth("0000000"+"\nLevel:00");
    ...
    public void updateDollar() {
        ...
        if(Play.mPlay.dollar_current == 0)
            s = "000";
        s = s + "\nLevel:" + String.valueOf(Level.levelCurrent);
    ...
    //-------------------------------------------------------------
    /**
    * Thêm hiệu ứng text trừ điểm khi lựa chọn trợ giúp
    */
